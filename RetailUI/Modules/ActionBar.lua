...
local function ReplaceBlizzardMicroMenuBarFrame(frameBar)
    ...
    local mainButton = MainMenuMicroButton
    mainButton.performanceFrame = mainButton.performanceFrame or CreateFrame('Frame', nil, mainButton)
    local performanceFrame = mainButton.performanceFrame
    ...
    performanceTexture:SetPoint('TOP', MainMenuMicroButton, "BOTTOM", 4, -2)
...
function Module:LoadDefaultSettings()
    ...
    RUI.DB.profile.widgets.microMenuBar = { anchor = "BOTTOMRIGHT", posX = 10, posY = 10, scale = 1 }
